...
public class HellowWorld 
{
	...
	public static void main(String[] adding_id, String[] severity)
	{
		...
		//проверка adding_id на sql-инъекцию
		//проверить наличие полученного id  в БД
		//executeQuery
		//"SELECT top 1 * from New_id where id = " + adding_id + ";"
		
		//если такого id нет - то выполнить добавление в sql-запросе
//		executeUpdate
//		"insert into New_id (`Id` ,`Severity`) value ( '" + adding_id + "', " + Severity + ");"
		
		//иначе вывести сообщение о существовании такого id
		     ...
		     public void run() { 
		         ...
		         try { 
		             ...
		             while(resultSet.next()){ 
		                 ...
		                 /*   или        String field1 = resultSet.getString(1); 
